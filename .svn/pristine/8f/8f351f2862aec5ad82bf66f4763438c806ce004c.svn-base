...
QT_MOC_LITERAL(1, 8, 9), // "lostFocus"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 8), // "PreView*"
QT_MOC_LITERAL(4, 28, 4) // "item"

    },
    "PreView\0lostFocus\0\0PreView*\0item"
};
...
void PreView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->lostFocus((*reinterpret_cast< PreView*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (PreView::*_t)(PreView * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PreView::lostFocus)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject PreView::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_PreView.data,
...
// SIGNAL 0
void PreView::lostFocus(PreView * _t1)
{
